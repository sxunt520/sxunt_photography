...
module.exports = {
  ...
  queryMobileLocationV2: function queryMobileLocationV2() {
    ...
    return request('https://common.apifm.com/' + subDomain + '/common/mobile-segment/location', false, 'get', { mobile: mobile });
  },
  ...
  commonIPV2: function commonIPV2() {
    ...
    return request('https://common.apifm.com/' + subDomain + '/common/ip', false, 'get', { ip: ip });
  },
  commonIPV3: function commonIPV3() {
    var ip = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';

    return request('https://common.apifm.com/' + subDomain + '/common/ip/v2', false, 'get', { ip: ip });
  },
  ...
  regionAnalysis: function regionAnalysis(address) {
    return request('https://common.apifm.com/' + subDomain + '/region/analysis', false, 'post', { address: address });
  },
  ...
  usersDynamic: function usersDynamic(type) {
    return request('https://common.apifm.com/' + subDomain + '/site/user/dynamic', false, 'get', { type: type });
  },
  ...
  partnerMembersStatistics: function partnerMembersStatistics(token) {
    return request('https://common.apifm.com/' + subDomain + '/partner/members/statistics', false, 'get', { token: token });
  },
  ...
  volcesArkCreateChatCompletion: function volcesArkCreateChatCompletion(message) {
    return request('https://common.apifm.com/' + subDomain + '/volcesArk/createChatCompletion', false, 'post', { message: message });
  },
  volcesArkChatCompletionResult: function volcesArkChatCompletionResult(key) {
    return request('https://common.apifm.com/' + subDomain + '/volcesArk/result', false, 'get', { key: key });
  }
};
